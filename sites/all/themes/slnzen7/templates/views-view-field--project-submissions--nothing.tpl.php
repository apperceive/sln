 ...
 */
  ...
  if (($survey_subject_tid == SLN_SUBJECT_SELF) && !$submission->is_draft) {
    $output = l('report', "slnsurvey/submission/report/$surveynid/$sid");
    $output .= "&nbsp;";
    $output .= "<a title='Download or view PDF version of report...' target='_blank' class='sln-download-pdf' href='/printpdf/slnsurvey/submission/report/$surveynid/$sid?pdf=yes'><span>PDF</span></a>";  }
  else {
    $output = "";
  } // if 
